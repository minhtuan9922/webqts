<div class="wrapper">
	...
	<div class="main">
		<div class="card">
			...
			<div class="card-body">
				<form action="<?=base_url('admin/hinhanh/chinhsua/'.$hinhanh['idhinhanh']) ?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="hinhanh">Hình ảnh</label>
						<input type="file" class="form-control <?php if(isset($error_hinhanh)) echo 'is-invalid'; ?>" id="hinhanh" name="hinhanh" placeholder="Hình ảnh">
						<div class="invalid-feedback"><?=isset($error_hinhanh) ? $error_hinhanh : '' ?></div>
						<div class="space10"></div>
						<img src="<?=base_url('img/hinhanh/'.$hinhanh['hinhanh']) ?>" id="images" width="200px" class="mx-auto d-block img-thumbnail">
						<input type="text" name="hinhanhcu" value="<?=$hinhanh['hinhanh'] ?>" hidden="">
					</div>
					<button type="submit" name="chinhsua" class="btn btn-primary">Chỉnh sửa hình ảnh</button>
				</form>
			</div>
		</div>
	</div>
